...
exports.isVSProject = exports.newProjectSettings = exports.getProjectSettingsVersion = exports.isPureExistingApp = exports.hasAzureResource = exports.hasSPFx = exports.hasAAD = exports.isValidProject = exports.validateProjectSettings = void 0;
...
function validateProjectSettings(projectSettings) {
    ...
    validateRes = validateStringArray(solutionSettings.capabilities, [
        ...
        question_1.TabSsoItem.id,
        question_1.BotSsoItem.id,
    ]);
    if (validateRes) {
...
function hasAzureResource(projectSetting, excludeAad = false) {
    ...
    const azurePlugins = [
        ...
        constants_1.BuiltInFeaturePluginNames.dotnet,
