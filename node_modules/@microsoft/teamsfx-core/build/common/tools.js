...
exports.undefinedName = exports.createV2Context = exports.getSideloadingStatus = exports.getAllowedAppMaps = exports.getAllowedAppIds = exports.redactObject = exports.IsSimpleAuthEnabled = exports.getHashedEnv = exports.isSPFxProject = exports.getUuid = exports.waitSeconds = exports.parseFromResourceId = exports.getSubscriptionIdFromResourceId = exports.getResourceGroupNameFromResourceId = exports.getSiteNameFromResourceId = exports.getStorageAccountNameFromResourceId = exports.getAppStudioEndpoint = exports.getAppDirectory = exports.compileHandlebarsTemplateString = exports.generateBicepFromFile = exports.isGeneratorCheckerEnabled = exports.isYoCheckerEnabled = exports.getRootDirectory = exports.isAADEnabled = exports.isApiConnectEnabled = exports.isM365AppEnabled = exports.isDeployManifestEnabled = exports.isAadManifestEnabled = exports.isExistingTabAppEnabled = exports.isConfigUnifyEnabled = exports.isBicepEnvCheckerEnabled = exports.isMultiEnvEnabled = exports.getResourceGroupInPortal = exports.askSubscription = exports.isCheckAccountError = exports.isUserCancelError = exports.deepCopy = exports.serializeDict = exports.replaceTemplateWithUserData = exports.convertDotenvToEmbeddedJson = exports.separateSecretData = exports.dataNeedEncryption = exports.AzurePortalUrl = exports.CryptoDataMatchers = exports.objectToConfigMap = exports.objectToMap = exports.mapToJson = exports.ensureUniqueFolder = exports.npmInstall = exports.Executor = void 0;
...
function isConfigUnifyEnabled() {
    return true;
}
exports.isConfigUnifyEnabled = isConfigUnifyEnabled;
...
function isAADEnabled(solutionSettings) {
    ...
    if (isAadManifestEnabled()) {
        return (solutionSettings.hostType === question_1.HostTypeOptionAzure.id &&
            (solutionSettings.capabilities.includes(question_1.TabSsoItem.id) ||
                solutionSettings.capabilities.includes(question_1.BotSsoItem.id)));
    }
    else {
        return (solutionSettings.hostType === question_1.HostTypeOptionAzure.id &&
        ...
        try {
            ...
            if (result !== undefined) {
                telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, {
                    [telemetry_1.TelemetryProperty.IsSideloadingAllowed]: result + "",
                });
            }
            else {
                telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, new teamsfx_api_1.SystemError("M365Account", "UnknownValue", `AppStudio response code: ${response.status}, body: ${response.data}`));
            }
            return result;
        }
        catch (error) {
            telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, new teamsfx_api_1.SystemError({ error, source: "M365Account" }));
