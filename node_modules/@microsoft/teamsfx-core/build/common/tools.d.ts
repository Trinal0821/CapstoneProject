...
import { AzureAccountProvider, ConfigMap, FxError, Json, Result, SubscriptionInfo, UserInteraction, ProjectSettings, AzureSolutionSettings, v2 } from "@microsoft/teamsfx-api";
...
export declare function isConfigUnifyEnabled(): boolean;
...
export declare function isAADEnabled(solutionSettings: AzureSolutionSettings): boolean;
