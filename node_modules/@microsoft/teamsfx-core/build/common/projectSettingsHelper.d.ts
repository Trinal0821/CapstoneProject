...
export declare function validateProjectSettings(projectSettings: ProjectSettings): string | undefined;
...
export declare function isPureExistingApp(projectSettings: ProjectSettings): boolean;
