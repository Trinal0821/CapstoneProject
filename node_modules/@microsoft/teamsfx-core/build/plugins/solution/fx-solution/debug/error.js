...
function LocalBotEndpointNotConfigured() {
    return new teamsfx_api_1.UserError(constants_1.SolutionSource, "LocalBotEndpointNotConfigured", localizeUtils_1.getDefaultString("error.LocalBotEndpointNotConfigured"), localizeUtils_1.getLocalizedString("error.LocalBotEndpointNotConfigured"));
}
