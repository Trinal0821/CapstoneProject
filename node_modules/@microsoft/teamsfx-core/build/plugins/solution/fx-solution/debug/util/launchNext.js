...
exports.generateM365Compounds = exports.generateM365Configurations = exports.generateCompounds = exports.generateConfigurations = void 0;
...
function generateM365Compounds(includeFrontend, includeBackend, includeBot) {
    ...
    launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.teams, "Edge", edgeOrder));
    launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.teams, "Chrome", chromeOrder));
    launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.outlook, "Edge", edgeOrder));
    launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.outlook, "Chrome", chromeOrder));
    if (includeFrontend) {
        launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.office, "Edge", edgeOrder));
        launchCompounds.push(debugM365(includeFrontend, includeBackend, includeBot, constants_1.HubName.office, "Chrome", chromeOrder));
    }
    return launchCompounds;
}
...
function debugM365(includeFrontend, includeBackend, includeBot, hubName, browserName, order) {
    const configurations = [];
    if (includeFrontend) {
