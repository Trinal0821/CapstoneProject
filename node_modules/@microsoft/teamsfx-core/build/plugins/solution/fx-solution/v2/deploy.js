...
async function deploy(ctx, inputs, envInfo, tokenProvider) {
    ...
    const provisioned = provisionOutputs[constants_3.GLOBAL_CONFIG][constants_3.SOLUTION_PROVISION_SUCCEEDED] ||
        inputs[constants_2.Constants.DEPLOY_AAD_FROM_CODELENS] === "yes";
    ...
    if (!isVsProject) {
        ...
        if (inputs[constants_2.Constants.INCLUDE_AAD_MANIFEST] === "yes" && inputs.platform === teamsfx_api_1.Platform.VSCode) {
    ...
    if (utils_1.isAzureProject(utils_1.getAzureSolutionSettings(ctx)) &&
        projectSettingsHelper_1.hasAzureResource(ctx.projectSetting, true) &&
        inputs[constants_2.Constants.INCLUDE_AAD_MANIFEST] !== "yes") {
