...
class DotnetPluginImpl {
    ...
    async localDebug(ctx) {
        ...
        if (tools_1.isConfigUnifyEnabled()) {
            ...
            (_c = (_b = ctx.localSettings) === null || _b === void 0 ? void 0 : _b.frontend) === null || _c === void 0 ? void 0 : _c.set(localSettingsConstants_1.LocalSettingsFrontendKeys.TabIndexPath, constants_1.DotnetPathInfo.indexPath);
        }
        return teamsfx_api_1.ok(undefined);
    }
    async postLocalDebug(ctx) {
        ...
        let appSettings = await errors_1.runWithErrorCatchAndThrow(new errors_1.FileIOError(appSettingsPath), async () => await fs_extra_1.default.readFile(appSettingsPath, "utf-8"));
        let clientId = constants_1.AppSettingsPlaceholders.clientId;
        let clientSecret = constants_1.AppSettingsPlaceholders.clientSecret;
        let tenantId = "";
        let oauthAuthority = constants_1.AppSettingsPlaceholders.oauthAuthority;
        let botId = constants_1.AppSettingsPlaceholders.botId;
        let botPassword = constants_1.AppSettingsPlaceholders.botPassword;
        if (tools_1.isConfigUnifyEnabled()) {
            clientId =
                (_b = (_a = ctx.envInfo.state.get(constants_3.PluginNames.AAD)) === null || _a === void 0 ? void 0 : _a.get(constants_1.DependentPluginInfo.aadClientId)) !== null && _b !== void 0 ? _b : constants_1.AppSettingsPlaceholders.clientId;
            clientSecret =
                (_d = (_c = ctx.envInfo.state.get(constants_3.PluginNames.AAD)) === null || _c === void 0 ? void 0 : _c.get(constants_1.DependentPluginInfo.aadClientSecret)) !== null && _d !== void 0 ? _d : constants_1.AppSettingsPlaceholders.clientSecret;
            tenantId = (_e = ctx.envInfo.state.get(constants_3.PluginNames.APPST)) === null || _e === void 0 ? void 0 : _e.get(constants_1.DependentPluginInfo.appTenantId);
            oauthAuthority = tenantId ? constants_1.DotnetPathInfo.oauthHost(tenantId) : constants_1.AppSettingsPlaceholders.oauthAuthority;
            botId =
                (_g = (_f = ctx.envInfo.state.get(constants_3.PluginNames.BOT)) === null || _f === void 0 ? void 0 : _f.get(constants_1.DependentPluginInfo.botId)) !== null && _g !== void 0 ? _g : constants_1.AppSettingsPlaceholders.botId;
            botPassword =
                (_j = (_h = ctx.envInfo.state.get(constants_3.PluginNames.BOT)) === null || _h === void 0 ? void 0 : _h.get(constants_1.DependentPluginInfo.botPassword)) !== null && _j !== void 0 ? _j : constants_1.AppSettingsPlaceholders.botPassword;
        }
        else {
            clientId =
                (_m = (_l = (_k = ctx.localSettings) === null || _k === void 0 ? void 0 : _k.auth) === null || _l === void 0 ? void 0 : _l.get(localSettingsConstants_1.LocalSettingsAuthKeys.ClientId)) !== null && _m !== void 0 ? _m : constants_1.AppSettingsPlaceholders.clientId;
            clientSecret =
                (_q = (_p = (_o = ctx.localSettings) === null || _o === void 0 ? void 0 : _o.auth) === null || _p === void 0 ? void 0 : _p.get(localSettingsConstants_1.LocalSettingsAuthKeys.ClientSecret)) !== null && _q !== void 0 ? _q : constants_1.AppSettingsPlaceholders.clientSecret;
            tenantId = (_s = (_r = ctx.localSettings) === null || _r === void 0 ? void 0 : _r.teamsApp) === null || _s === void 0 ? void 0 : _s.get(localSettingsConstants_1.LocalSettingsTeamsAppKeys.TenantId);
            oauthAuthority = tenantId ? constants_1.DotnetPathInfo.oauthHost(tenantId) : constants_1.AppSettingsPlaceholders.oauthAuthority;
            botId = (_v = (_u = (_t = ctx.localSettings) === null || _t === void 0 ? void 0 : _t.bot) === null || _u === void 0 ? void 0 : _u.get(localSettingsConstants_1.LocalSettingsBotKeys.BotId)) !== null && _v !== void 0 ? _v : constants_1.AppSettingsPlaceholders.botId;
            botPassword =
                (_y = (_x = (_w = ctx.localSettings) === null || _w === void 0 ? void 0 : _w.bot) === null || _x === void 0 ? void 0 : _x.get(localSettingsConstants_1.LocalSettingsBotKeys.BotPassword)) !== null && _y !== void 0 ? _y : constants_1.AppSettingsPlaceholders.botPassword;
        }
        ...
        appSettings = appSettings.replace(constants_1.RegularExpr.botId, botId);
        appSettings = appSettings.replace(constants_1.RegularExpr.botPassword, botPassword);
