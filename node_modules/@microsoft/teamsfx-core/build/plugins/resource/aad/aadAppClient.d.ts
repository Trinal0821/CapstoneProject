import { GraphTokenProvider, PluginContext, v2 } from "@microsoft/teamsfx-api";
...
export declare class AadAppClient {
    ...
    static getAadAppUsingManifest(stage: string, objectId: string, clientSecret: string | undefined, graphTokenProvider?: GraphTokenProvider, envName?: string, skip?: boolean): Promise<ProvisionConfig>;
    static getAadApp(stage: string, objectId: string, clientSecret: string | undefined, graphTokenProvider?: GraphTokenProvider, envName?: string, skip?: boolean): Promise<ProvisionConfig>;
