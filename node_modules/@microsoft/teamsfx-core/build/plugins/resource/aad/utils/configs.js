...
class Utils {
    ...
    static async getCurrentTenantId(graphTokenProvider) {
        var _a;
        const tokenObject = await (graphTokenProvider === null || graphTokenProvider === void 0 ? void 0 : graphTokenProvider.getJsonObject());
...
class SetApplicationInContextConfig {
    ...
    restoreConfigFromContext(ctx) {
        ...
        if (common_1.isAadManifestEnabled()) {
            ...
            if (botEndpoint) {
                this.botEndpoint = format_1.format(frontendDomain, format_1.Formats.Domain);
            }
        }
