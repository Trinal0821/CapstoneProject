...
async function _provision(ctx, progressBar) {
    ...
    const aadManager = await factory_1.Factory.buildAadManager(ctx.graphTokenProvider, ctx.telemetryReporter, ctx.logProvider);
    const appName = error_1.AssertNotEmpty("projectSettings.appName", (_a = ctx === null || ctx === void 0 ? void 0 : ctx.projectSettings) === null || _a === void 0 ? void 0 : _a.appName);
...
async function _postProvision(ctx, progressBar) {
    ...
    const aadManager = await factory_1.Factory.buildAadManager(ctx.graphTokenProvider, ctx.telemetryReporter, ctx.logProvider);
    const teamsAppAadManager = await factory_1.Factory.buildTeamsAppAadManager(ctx.graphTokenProvider, ctx.telemetryReporter, ctx.logProvider);
