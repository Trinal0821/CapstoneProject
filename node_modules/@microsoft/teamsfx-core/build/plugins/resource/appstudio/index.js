...
let AppStudioPlugin = class AppStudioPlugin {
    ...
    async publish(ctx) {
        ...
        try {
            ...
            const msg = localizeUtils_1.getLocalizedString("plugins.appstudio.publishSucceedNotice", result.name, constants_1.Constants.TEAMS_ADMIN_PORTAL);
            if (((_d = ctx.answers) === null || _d === void 0 ? void 0 : _d.platform) === teamsfx_api_1.Platform.CLI) {
                (_e = ctx.ui) === null || _e === void 0 ? void 0 : _e.showMessage("info", msg.replace("[", "").replace("]", "") +
                    ` Learn more from ${constants_1.Constants.TEAMS_MANAGE_APP_DOC}.`, false);
            }
            else {
                (_f = ctx.ui) === null || _f === void 0 ? void 0 : _f.showMessage("info", msg, false, constants_1.Constants.LEARN_MORE, constants_1.Constants.ADMIN_PORTAL).then((value) => {
                    var _a, _b;
