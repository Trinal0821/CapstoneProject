...
let AppStudioPluginV3 = class AppStudioPluginV3 {
    ...
    async init(ctx, inputs) {
        ...
        const res = await manifestTemplate_1.init(inputs.projectPath, ctx.projectSetting.appName, projectSettingsHelper_1.isPureExistingApp(ctx.projectSetting));
        if (res.isErr())
    ...
    async preCheck(projectPath) {
        ...
        const appPackageDir = path.resolve(projectPath, constants_2.APP_PACKAGE_FOLDER_FOR_MULTI_ENV);
