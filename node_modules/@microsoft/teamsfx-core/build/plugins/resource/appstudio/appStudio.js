...
(function (AppStudioClient) {
    const baseUrl = tools_1.getAppStudioEndpoint();
    /**
    ...
    async function createApp(file, appStudioToken, logProvider) {
        ...
        try {
            ...
            const message = (((_b = e.response) === null || _b === void 0 ? void 0 : _b.data) ? `data: ${JSON.stringify(e.response.data)}` : "") +
                (correlationId ? `X-Correlation-ID: ${correlationId}` : "");
            const error = new Error(localizeUtils_1.getLocalizedString("error.appstudio.teamsAppCreateFailed", e.name, e.message, message));
            if ((_c = e.response) === null || _c === void 0 ? void 0 : _c.status) {
                error.name = (_d = e.response) === null || _d === void 0 ? void 0 : _d.status;
            }
            throw error;
        }
    }
