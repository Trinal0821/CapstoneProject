...
class FunctionPluginError extends Error {
    ...
    getMessage() {
        return localizeUtils_1.getLocalizedString("plugins.baseErrorMessage", this.message[1], this.suggestions.join(" "));
    }
    getDefaultMessage() {
        return localizeUtils_1.getDefaultString("plugins.baseErrorMessage", this.message[0], this.suggestions.join(" "));
    }
}
