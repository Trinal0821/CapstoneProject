...
let FunctionPluginV3 = class FunctionPluginV3 {
    ...
    async getValidNodeVersion(projectPath) {
        var _a;
        const currentNodeVersion = await node_version_1.getNodeVersion(this.getFunctionProjectRootPath(projectPath));
        const candidateNodeVersions = Object.values(enums_1.NodeVersion);
        return ((_a = candidateNodeVersions.find((v) => v === currentNodeVersion)) !== null && _a !== void 0 ? _a : constants_3.DefaultValues.nodeVersion);
    }
    async getSite(projectPath, client, resourceGroupName, functionAppName) {
    ...
    async configureResource(ctx, inputs, envInfo, tokenProvider) {
        ...
        const site = await this.getSite(inputs.projectPath, webSiteManagementClient, resourceGroupName, functionAppName);
