...
export declare const SourceCodeDir = "src";
...
export declare class DeployStatus {
    static readonly RETRY_TIMES = 60;
...
export declare type CustomizedTask = typeof CustomizedTasks[keyof typeof CustomizedTasks];
