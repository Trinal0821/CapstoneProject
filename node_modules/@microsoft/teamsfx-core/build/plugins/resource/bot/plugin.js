...
class TeamsBotImpl {
    ...
    async scaffold(context) {
        ...
        if (featureFlags_1.isBotNotificationEnabled()) {
            this.config.scaffold.hostType = strings_1.HostTypes.APP_SERVICE;
        }
    ...
    async generateArmTemplates(ctx) {
        ...
        const pluginCtx = {
            ...
            enableAlwaysOn: featureFlags_1.isBotNotificationEnabled(),
        };
        const bicepTemplateDir = path_1.default.join(folder_1.getTemplatesFolder(), constants_1.PathInfo.BicepTemplateRelativeDir);
    ...
    async postLocalDebug(context) {
        ...
        if (tools_1.isConfigUnifyEnabled()) {
            ...
            errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.LOCAL_ENDPOINT, this.config.localDebug.localEndpoint);
    ...
    async updateMessageEndpointOnAppStudio(endpoint) {
        var _a, _b, _c, _d, _e;
        const appStudioToken = errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.APPSTUDIO_TOKEN, await ((_b = (_a = this.ctx) === null || _a === void 0 ? void 0 : _a.appStudioToken) === null || _b === void 0 ? void 0 : _b.getAccessToken()));
        errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.LOCAL_BOT_ID, tools_1.isConfigUnifyEnabled()
            ? (_c = this.ctx) === null || _c === void 0 ? void 0 : _c.envInfo.state.get(constants_2.ResourcePlugins.Bot).get(constants_3.BOT_ID)
            : this.config.localDebug.localBotId);
        const botReg = {
            botId: tools_1.isConfigUnifyEnabled()
                ? (_d = this.ctx) === null || _d === void 0 ? void 0 : _d.envInfo.state.get(constants_2.ResourcePlugins.Bot).get(constants_3.BOT_ID)
                : this.config.localDebug.localBotId,
            name: ((_e = this.ctx.projectSettings) === null || _e === void 0 ? void 0 : _e.appName) + strings_1.PluginLocalDebug.LOCAL_DEBUG_SUFFIX,
            description: "",
            iconUrl: "",
    ...
    async createNewBotRegistrationOnAppStudio() {
        ...
        const token = errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.GRAPH_TOKEN, await ((_b = (_a = this.ctx) === null || _a === void 0 ? void 0 : _a.graphTokenProvider) === null || _b === void 0 ? void 0 : _b.getAccessToken()));
        ...
        // && (await AppStudio.isAADAppExisting(appStudioToken!, this.config.localDebug.localObjectId!))
        ...
        else if (tools_1.isConfigUnifyEnabled() &&
            ((_f = (_e = this.ctx) === null || _e === void 0 ? void 0 : _e.envInfo.state.get(constants_2.ResourcePlugins.Bot)) === null || _f === void 0 ? void 0 : _f.get(constants_3.BOT_ID))) {
            ...
            botAuthCreds.clientSecret = (_j = this.ctx) === null || _j === void 0 ? void 0 : _j.envInfo.state.get(constants_2.ResourcePlugins.Bot).get(strings_1.PluginBot.OBJECT_ID);
            logger_1.Logger.debug(messages_1.Messages.SuccessfullyGetExistingBotAadAppCredential);
        }
        else {
        ...
        const botReg = {
            ...
            name: ((_k = this.ctx.projectSettings) === null || _k === void 0 ? void 0 : _k.appName) + strings_1.PluginLocalDebug.LOCAL_DEBUG_SUFFIX,
            description: "",
            iconUrl: "",
            messagingEndpoint: "",
            callingEndpoint: "",
        ...
        logger_1.Logger.info(messages_1.Messages.ProvisioningBotRegistration);
        const appStudioToken = errors_1.checkAndThrowIfMissing(strings_1.ConfigNames.APPSTUDIO_TOKEN, await ((_m = (_l = this.ctx) === null || _l === void 0 ? void 0 : _l.appStudioToken) === null || _m === void 0 ? void 0 : _m.getAccessToken()));
