...
let CICDPluginV2 = class CICDPluginV2 {
    ...
    async getQuestionsForUserTask(ctx, inputs, func, envInfo, tokenProvider) {
        ...
        if (inputs.platform !== teamsfx_api_1.Platform.CLI_HELP && common_1.isPureExistingApp(ctx.projectSetting)) {
        ...
        const whichProvider = new teamsfx_api_1.QTreeNode({
        ...
        const whichTemplate = new teamsfx_api_1.QTreeNode({
        ...
        if (inputs.platform === teamsfx_api_1.Platform.VSCode) {
            ...
            if (envProfilesResult.isErr()) {
                throw new errors_1.InternalError(["Failed to list multi env.", "Failed to list multi env."], envProfilesResult.error);
            }
