...
const ErrorHandlerMW = async (ctx, next) => {
    ...
    try {
        let log = `[core] start task:${taskName}, API v3: ${globalVars_1.isV3()}`;
        if (inputs.loglevel && inputs.loglevel === "Debug") {
            ...
            (_b = globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider) === null || _b === void 0 ? void 0 : _b.info(log);
        }
        const time = new Date().getTime();
        await next();
        log = `[core] finish task:${taskName}, time: ${new Date().getTime() - time} ms`;
        if (inputs.loglevel && inputs.loglevel === "Debug") {
            (_c = globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider) === null || _c === void 0 ? void 0 : _c.debug(log);
        }
        else {
            (_d = globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider) === null || _d === void 0 ? void 0 : _d.info(log);
        }
    }
    catch (e) {
...
async function tryConvertToUserError(err) {
    ...
    for (const reg of Regs) {
        if (reg.test(msg) === true) {
            const userError = new teamsfx_api_1.UserError(err.source, err.name, err.message);
