...
const manifestTemplate_1 = require("../../plugins/resource/appstudio/manifestTemplate");
const folder_1 = require("../../folder");
const projectSettingsLoader_1 = require("./projectSettingsLoader");
const projectMigrator_1 = require("./projectMigrator");
const util = tslib_1.__importStar(require("util"));
const constants_1 = require("../../plugins/resource/spfx/utils/constants");
...
async function upgrade(ctx, next, showModal) {
    ...
    do {
        const res = await (globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.ui.showMessage("warn", localizeUtils_1.getLocalizedString("core.consolidateLocalRemote.Message"), showModal, upgradeButton, LearnMore));
...
async function needConsolidateLocalRemote(ctx) {
    ...
    const consolidateManifestExist = await fs_extra_1.default.pathExists(path_1.default.join(inputs.projectPath, "templates", "appPackage", "manifest.template.json"));
    ...
    try {
        ...
        if (remoteManifestExist) {
            if (tools_1.isSPFxProject(projectSettings)) {
                ...
                const manifestTemplatePath = await manifestTemplate_1.getManifestTemplatePath(inputs.projectPath);
...
async function postConsolidate(projectPath, ctx, inputs, backupFolder, moveFiles) {
    ...
    if (inputs.platform !== teamsfx_api_1.Platform.VSCode) {
        globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider.info(localizeUtils_1.getLocalizedString("core.consolidateLocalRemote.SuccessMessage"));
    }
}
