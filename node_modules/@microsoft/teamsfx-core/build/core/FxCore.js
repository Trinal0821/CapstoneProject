    ...
    async createProjectV3(inputs, ctx) {
        ...
        if (scratch === question_2.ScratchOptionNo.id) {
            ...
            if (!((_a = inputs.existingAppConfig) === null || _a === void 0 ? void 0 : _a.isCreatedFromExistingApp)) {
                // addFeature
                const features = [];
                if (!tools_1.isAadManifestEnabled() && !capabilities.includes(question_1.TabSPFxItem.id)) {
                    features.push(constants_1.BuiltInFeaturePluginNames.aad);
                }
                if (tools_1.isAadManifestEnabled() &&
                    (capabilities.includes(question_1.TabSsoItem.id) || capabilities.includes(question_1.BotSsoItem.id))) {
                    features.push(constants_1.BuiltInFeaturePluginNames.aad);
                }
