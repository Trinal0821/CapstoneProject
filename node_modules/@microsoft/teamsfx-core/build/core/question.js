        ...
        validation: {
            validFunc: async (input, previousInputs) => {
                ...
                if (validateProjectPathExistence && previousInputs && previousInputs.folder) {
                    let folder = previousInputs.folder;
                    if (previousInputs.platform === teamsfx_api_1.Platform.VSCode) {
