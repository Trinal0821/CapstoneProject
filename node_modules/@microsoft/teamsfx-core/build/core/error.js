...
function ConsolidateCanceledError() {
    ...
    "UserCancel", localizeUtils_1.getLocalizedString("error.ConsolidateCanceledError"), exports.CoreSource);
}
exports.ConsolidateCanceledError = ConsolidateCanceledError;
function AadManifestMigrationCanceledError() {
    return new teamsfx_api_1.UserError("UserCancel", localizeUtils_1.getLocalizedString("error.AadManifestMigrationCanceledError"), exports.CoreSource);
}
exports.AadManifestMigrationCanceledError = AadManifestMigrationCanceledError;
