import { CoreCallbackEvent, CoreCallbackFunc, Func, FunctionRouter, FxError, Inputs, ProjectConfig, ProjectConfigV3, ProjectSettings, QTreeNode, Result, Stage, Tools, v2, v3, Void } from "@microsoft/teamsfx-api";
...
export declare class FxCore implements v3.ICore {
    ...
    executeUserTaskV3(func: Func, inputs: Inputs, ctx?: CoreHookContext): Promise<Result<unknown, FxError>>;
    ...
    createEnvWithName(targetEnvName: string, projectSettings: ProjectSettings, inputs: Inputs, existingTabEndpoint?: string): Promise<Result<Void, FxError>>;
    ...
    addFeature(inputs: v2.InputsWithProjectPath, ctx?: CoreHookContext): Promise<Result<Void, FxError>>;
    _addFeature(inputs: v2.InputsWithProjectPath, ctx?: CoreHookContext): Promise<Result<Void, FxError>>;
