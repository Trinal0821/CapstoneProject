...
export declare const ProjectNamePattern = "^[a-zA-Z][\\da-zA-Z]+$";
export declare function createAppNameQuestion(validateProjectPathExistence?: boolean): TextInputQuestion;
